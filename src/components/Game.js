export default class Game {
  ...
  genCount = () => {
    this.generation = setInterval(this.gen + 1);
  };
  ...
  operations = (i, j) => {
    ...
    const leftBottomNeighbor = [
      [-1, this.size - 1],
      [-1, 0],
      [-1, 1],
      [0, this.size - 1],
      [0, 1],
      [1 - this.size, this.size - 1],
      [1 - this.size, 0],
      [1 - this.size, 1],
    ];
    const rightBottomNeighbor = [
      [-1, -1],
      [-1, 0],
      [-1, 1 - this.size],
      [0, -1],
